...
@interface IMCreditsTooltipView ()
{
...
@implementation IMCreditsTooltipView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        creditsLabel.font = [IMFont standardRegularFontWithSize:16.0f];
...
- (void)layoutSubviews
{
    ...
    CGRect creditsRect = [credits boundingRectWithSize:CGSizeMake(225, CGFLOAT_MAX)
                                            ...
                                            attributes:@{NSFontAttributeName:[IMFont standardRegularFontWithSize:16.0f]}
                                               context:nil];

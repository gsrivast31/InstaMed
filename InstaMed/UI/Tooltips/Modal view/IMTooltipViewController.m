...
@interface IMTooltipViewController ()
{
    UIButton *closeButton;
}
@property (nonatomic, strong) IMModalViewPane *pane;
@property (nonatomic, assign) BOOL isDismissing;

@end

@implementation IMTooltipViewController
...
- (void)loadView
{
    ...
    self.pane = [[IMModalViewPane alloc] initWithFrame:CGRectZero];
...
@implementation IMModalViewPane

...
@interface IMSlider ()
@property (nonatomic, strong) IMSliderPopoverView *popoverView;
...
- (void)createPopover
{
    _popoverView = [[IMSliderPopoverView alloc] initWithFrame:CGRectZero];
...
@implementation IMSliderPopoverView

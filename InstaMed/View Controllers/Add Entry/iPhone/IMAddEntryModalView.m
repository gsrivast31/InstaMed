...
@implementation IMAddEntryModalView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        IMAddEntryModalButton *medicineButton = [[IMAddEntryModalButton alloc] initWithFrame:CGRectMake(1.0f, 0.0f, width, height)];
        ...
        IMAddEntryModalButton *readingButton = [[IMAddEntryModalButton alloc] initWithFrame:CGRectMake(2.0f + width, 0.0f, width, height)];
        ...
        IMAddEntryModalButton *mealButton = [[IMAddEntryModalButton alloc] initWithFrame:CGRectMake(1.0f, 1.0f + height, width, height)];
        [mealButton setTag:2];
        ...
        IMAddEntryModalButton *activityButton = [[IMAddEntryModalButton alloc] initWithFrame:CGRectMake(2.0f + width, 1.0f + height, width, height)];
        ...
        IMAddEntryModalButton *noteButton = [[IMAddEntryModalButton alloc] initWithFrame:CGRectMake(1.0f, 2.0f + height*2, width, height)];
        [noteButton setTag:4];
        ...
        IMAddEntryModalButton *cancelButton = [[IMAddEntryModalButton alloc] initWithFrame:CGRectMake(2.0f + width, 2.0f + height*2, width, height)];

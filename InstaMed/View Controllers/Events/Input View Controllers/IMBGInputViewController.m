...
@interface IMBGInputViewController ()
{
    NSString *value;
    NSString *mgValue;
    NSString *mmoValue;
...
@implementation IMBGInputViewController
...
- (NSArray *)suggestionsForAutocompleteBar:(IMAutocompleteBar *)theAutocompleteBar
{
    ...
    {
        return [[IMEventController sharedInstance] fetchKey:@"name" forEventsWithFilterType:ReadingFilterType];
    }
    else
    {

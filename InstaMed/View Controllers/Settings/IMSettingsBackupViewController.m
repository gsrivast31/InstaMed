//
//  IMSettingsBackupViewController.m
//  InstaMed
//
//  Created by GAURAV SRIVASTAVA on 23/05/2014.
...
@interface IMSettingsBackupViewController ()
{
    IMBackupController *backupController;
...
@implementation IMSettingsBackupViewController
...
- (id)init
{
    ...
    if (self)
    {
        ...
        backupController = [[IMBackupController alloc] init];
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    warningLabel.font = [IMFont standardRegularFontWithSize:14.0f];

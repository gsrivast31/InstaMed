...
@interface IMDatePickerController ()
...
@implementation IMDatePickerController
...
- (id)initWithFrame:(CGRect)frame andDate:(NSDate *)date
{
    ...
    if (self) {
        ...
        [[cancelButton titleLabel] setFont:[IMFont standardMediumFontWithSize:19.0f]];
        ...
        [[doneButton titleLabel] setFont:[IMFont standardMediumFontWithSize:19.0f]];

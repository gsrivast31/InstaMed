...
@implementation IMTimelineViewCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self)
    {
        ...
        _descriptionLabel.font = [IMFont standardMediumFontWithSize:16.0f];
        ...
        _valueLabel.font = [IMFont standardRegularFontWithSize:16.0f];
        ...
        _timestampLabel.font = [IMFont standardRegularFontWithSize:16.0f];
...
- (void)layoutSubviews
{
    ...
    if(self.cellPosition == IMCellBackgroundViewPositionBottom)
    {
            ...
            andTableView:(UITableView *)tableView
{
    ...
    if (CGRectContainsPoint(textView.bounds, location) && characterIndex < textView.textStorage.length)
    {
        ...
        if(tagValue)
        {
            ...
            IMTimelineViewController *timelineVC = [[IMTimelineViewController alloc] initWithTag:tagValue];

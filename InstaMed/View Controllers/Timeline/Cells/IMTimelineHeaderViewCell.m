...
@interface IMTimelineHeaderViewCell ()
{
...
@implementation IMTimelineHeaderViewCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if(self)
    {
        ...
        _dateLabel.font = [IMFont standardRegularFontWithSize:14.0f];
        ...
        _glucoseStatView = [[IMTimelineStatView alloc] initWithFrame:CGRectZero];
        ...
        _activityStatView = [[IMTimelineStatView alloc] initWithFrame:CGRectZero];
        ...
        _mealStatView = [[IMTimelineStatView alloc] initWithFrame:CGRectZero];

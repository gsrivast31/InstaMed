//
//  IMAnalyticsLineChartViewController.m
...
typedef NS_ENUM(NSInteger, IMAnalyticsLineChartLine){
	IMAnalyticsLineChartLineSolid,
    IMAnalyticsLineChartLineDashed,
...
@interface IMAnalyticsLineChartViewController () <JBLineChartViewDelegate, JBLineChartViewDataSource>
...
@implementation IMAnalyticsLineChartViewController
...
- (void)loadView
{
    ...
    IMAnalyticsChartHeaderView *headerView = [[IMAnalyticsChartHeaderView alloc] initWithFrame:CGRectMake(kJBLineChartViewControllerChartPadding, ceil(self.view.bounds.size.height * 0.5) - ceil(kJBLineChartViewControllerChartHeaderHeight * 0.5), self.view.bounds.size.width - (kJBLineChartViewControllerChartPadding * 2), kJBLineChartViewControllerChartHeaderHeight)];
...
- (void)lineChartView:(JBLineChartView *)lineChartView didSelectLineAtIndex:(NSUInteger)lineIndex horizontalIndex:(NSUInteger)horizontalIndex touchPoint:(CGPoint)touchPoint
{
    ...
    [self.informationView setTitleText:lineIndex == IMAnalyticsLineChartLineSolid ? kJBStringLabelMetropolitanAverage : kJBStringLabelNationalAverage];
...
{
    return (lineIndex == IMAnalyticsLineChartLineSolid) ? kJBColorLineChartDefaultSolidLineColor: kJBColorLineChartDefaultDashedLineColor;
}
...
{
    return (lineIndex == IMAnalyticsLineChartLineSolid) ? kJBLineChartViewControllerChartSolidLineWidth: kJBLineChartViewControllerChartDashedLineWidth;
}

- (CGFloat)lineChartView:(JBLineChartView *)lineChartView dotRadiusForDotAtHorizontalIndex:(NSUInteger)horizontalIndex atLineIndex:(NSUInteger)lineIndex
{
    return (lineIndex == IMAnalyticsLineChartLineSolid) ? 0.0: (kJBLineChartViewControllerChartDashedLineWidth * 4);
}
...
{
    return (lineIndex == IMAnalyticsLineChartLineSolid) ? kJBColorLineChartDefaultSolidSelectedLineColor: kJBColorLineChartDefaultDashedSelectedLineColor;
}
...
{
    return (lineIndex == IMAnalyticsLineChartLineSolid) ? JBLineChartViewLineStyleSolid : JBLineChartViewLineStyleDashed;
}

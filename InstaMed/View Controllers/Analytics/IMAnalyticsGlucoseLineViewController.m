//
//  IMAnalyticsGlucoseLineViewController.m
//  InstaMed
//
...
@interface IMAnalyticsGlucoseLineViewController () <JBLineChartViewDelegate, JBLineChartViewDataSource>
...
@implementation IMAnalyticsGlucoseLineViewController
...
- (CGFloat)lineChartView:(JBLineChartView *)lineChartView verticalValueForHorizontalIndex:(NSUInteger)horizontalIndex atLineIndex:(NSUInteger)lineIndex {
    if (lineIndex < 2) {
        ...
        return [[[NSUserDefaults standardUserDefaults] objectForKey:kMinHealthyBGKey] floatValue];
    } else {
        return [[[NSUserDefaults standardUserDefaults] objectForKey:kMaxHealthyBGKey] floatValue];
    }
    return 0.0f;
}
...
- (void)lineChartView:(JBLineChartView *)lineChartView didSelectLineAtIndex:(NSUInteger)lineIndex horizontalIndex:(NSUInteger)horizontalIndex touchPoint:(CGPoint)touchPoint {
    ...
    if (lineIndex < 2) {
        ...
        valueNumber = [NSNumber numberWithDouble:[[[NSUserDefaults standardUserDefaults] objectForKey:kMinHealthyBGKey] doubleValue]];
        title = @"Minimum Healthy Reading";
    } else {
        valueNumber = [NSNumber numberWithDouble:[[[NSUserDefaults standardUserDefaults] objectForKey:kMaxHealthyBGKey] doubleValue]];

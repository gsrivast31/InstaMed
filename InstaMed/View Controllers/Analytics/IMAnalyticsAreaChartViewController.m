//
//  IMAnalyticsAreaChartViewController.m
...
typedef NS_ENUM(NSInteger, IMAnalyticsLineChartLine){
	IMAnalyticsLineChartLineSun,
    IMAnalyticsLineChartLineMoon,
    IMAnalyticsLineChartLineCount
};
...
@interface IMAnalyticsAreaChartViewController () <JBLineChartViewDelegate, JBLineChartViewDataSource>
...
@implementation IMAnalyticsAreaChartViewController
...
- (id)initWithFromDate:(NSDate*)aFromDate toDate:(NSDate*)aToDate {
    self = [super initWithFromDate:aFromDate toDate:aToDate];
    return self;
}
...
- (void)initFakeData {
    ...
    for (int lineIndex=0; lineIndex<IMAnalyticsLineChartLineCount; lineIndex++) {
...
- (void)loadView {
    ...
    IMAnalyticsChartHeaderView *headerView = [[IMAnalyticsChartHeaderView alloc] initWithFrame:CGRectMake(kJBAreaChartViewControllerChartPadding, ceil(self.view.bounds.size.height * 0.5) - ceil(kJBAreaChartViewControllerChartHeaderHeight * 0.5), self.view.bounds.size.width - (kJBAreaChartViewControllerChartPadding * 2), kJBAreaChartViewControllerChartHeaderHeight)];
...
- (void)lineChartView:(JBLineChartView *)lineChartView didSelectLineAtIndex:(NSUInteger)lineIndex horizontalIndex:(NSUInteger)horizontalIndex touchPoint:(CGPoint)touchPoint {
    ...
    [self.informationView setTitleText:lineIndex == IMAnalyticsLineChartLineSun ? kJBStringLabelSun : kJBStringLabelMoon];
...
- (UIColor *)lineChartView:(JBLineChartView *)lineChartView colorForLineAtLineIndex:(NSUInteger)lineIndex {
    return (lineIndex == IMAnalyticsLineChartLineSun) ? kJBColorAreaChartDefaultSunLineColor: kJBColorAreaChartDefaultMoonLineColor;
}

- (UIColor *)lineChartView:(JBLineChartView *)lineChartView fillColorForLineAtLineIndex:(NSUInteger)lineIndex {
    return (lineIndex == IMAnalyticsLineChartLineSun) ? kJBColorAreaChartDefaultSunAreaColor : kJBColorAreaChartDefaultMoonAreaColor;
}
...
- (UIColor *)lineChartView:(JBLineChartView *)lineChartView selectionColorForLineAtLineIndex:(NSUInteger)lineIndex {
    return (lineIndex == IMAnalyticsLineChartLineSun) ? kJBColorAreaChartDefaultSunSelectedLineColor: kJBColorAreaChartDefaultMoonSelectedLineColor;
}

- (UIColor *)lineChartView:(JBLineChartView *)lineChartView selectionFillColorForLineAtLineIndex:(NSUInteger)lineIndex {
    return (lineIndex == IMAnalyticsLineChartLineSun) ? kJBColorAreaChartDefaultSunSelectedAreaColor : kJBColorAreaChartDefaultMoonSelectedAreaColor;
}

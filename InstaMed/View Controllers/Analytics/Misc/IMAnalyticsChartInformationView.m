//
//  IMAnalyticsChartInformationView.m
...
// Colors (IMAnalyticsChartInformationView)
...
@interface IMAnalyticsChartValueView : UIView
...
@interface IMAnalyticsChartInformationView ()

@property (nonatomic, strong) IMAnalyticsChartValueView *valueView;
...
@implementation IMAnalyticsChartInformationView

#pragma mark - Alloc/Init

+ (void)initialize
{
	if (self == [IMAnalyticsChartInformationView class])
	{
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        _valueView = [[IMAnalyticsChartValueView alloc] initWithFrame:[self valueViewRect]];
...
@implementation IMAnalyticsChartValueView

#pragma mark - Alloc/Init

+ (void)initialize
{
	if (self == [IMAnalyticsChartValueView class])
	{

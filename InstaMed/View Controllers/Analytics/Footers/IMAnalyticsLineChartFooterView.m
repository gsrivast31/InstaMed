//
//  IMAnalyticsLineChartFooterView.m
...
@interface IMAnalyticsLineChartFooterView ()

@property (nonatomic, strong) UIView *topSeparatorView;

@end

@implementation IMAnalyticsLineChartFooterView

#pragma mark - Alloc/Init

+ (void)initialize
{
	if (self == [IMAnalyticsLineChartFooterView class])
	{

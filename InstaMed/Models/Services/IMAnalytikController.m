...
@interface IMAnalytikController ()
{
...
- (NSDictionary *)representationForEvent:(IMEvent *)event;
- (NSError *)responseError:(NSDictionary *)response;

@end

@implementation IMAnalytikController
...
- (NSManagedObjectContext *)managedObjectContext
{
    if(!_managedObjectContext)
    {
        ...
        _managedObjectContext.parentContext = [[IMCoreDataController sharedInstance] managedObjectContext];
    }
...
- (NSArray *)eventsToSyncFromDate:(NSDate *)fromDate
{
    ...
    if(moc)
    {
        [moc performBlockAndWait:^{
            ...
            events = [[IMEventController sharedInstance] fetchEventsWithPredicate:predicate
...
- (NSDictionary *)representationForEvent:(IMEvent *)event
{
    ...
    if([event isKindOfClass:[IMMedicine class]])
    {

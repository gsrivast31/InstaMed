...
{
	NSDateComponents *components1 = [CURRENT_CALENDAR components:NSCalendarUnitMonth|NSCalendarUnitYear fromDate:self];
	NSDateComponents *components2 = [CURRENT_CALENDAR components:NSCalendarUnitMonth|NSCalendarUnitYear fromDate:aDate];
...
- (NSDate *)dateAtStartOfMonth
{
    ...
    NSDateComponents *comp = [[NSCalendar currentCalendar] components:(NSCalendarUnitYear | NSCalendarUnitMonth | NSCalendarUnitDay) fromDate:startOfDay];
    [comp setDay:1];
